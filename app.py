    ...
    <body>
        <div class="container">
            ...
            <div class="card">
                ...
                <form method="post" action="/close-all-positions" onsubmit="return confirm('Close ALL positions?');">
                    <button type="submit" class="danger">🚨 Close All</button>
                </form>
                <table>
                    <thead><tr><th>Symbol</th><th>Units</th><th>Entry</th><th>P/L</th></tr></thead>
                    <tbody>
